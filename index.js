...
// include: C:\Users\jtoom\AppData\Local\Temp\tmp8jui6aki.js
...
Module['FS_createPath']("/", "game_data", true, true);
    ...
    loadPackage({"files": [{"filename": "/game_data/ASSETS.PAK", "start": 0, "end": 812800}, {"filename": "/game_data/ASSETS.TOC", "start": 812800, "end": 822188}, {"filename": "/game_data/AUDIO.PAK", "start": 822188, "end": 960876}, {"filename": "/game_data/AUDIO.TOC", "start": 960876, "end": 961992}, {"filename": "/game_data/BIG.PAK", "start": 961992, "end": 1007756}, {"filename": "/game_data/BIG.TOC", "start": 1007756, "end": 1008472}, {"filename": "/game_data/BIR.PAK", "start": 1008472, "end": 1035380}, {"filename": "/game_data/BIR.TOC", "start": 1035380, "end": 1036504}, {"filename": "/game_data/CHARDB.BIN", "start": 1036504, "end": 1036668}, {"filename": "/game_data/MOO.PAK", "start": 1036668, "end": 1106300}, {"filename": "/game_data/MOO.TOC", "start": 1106300, "end": 1107832}, {"filename": "/game_data/PALMETA.BIN", "start": 1107832, "end": 1107876}, {"filename": "/game_data/ST1.ogg", "start": 1107876, "end": 7054572}, {"filename": "/game_data/WIN.ogg", "start": 7054572, "end": 7445942}, {"filename": "/game_data/map.bin", "start": 7445942, "end": 7812161}, {"filename": "/game_data/menu.bin", "start": 7812161, "end": 7850647}, {"filename": "/game_data/palette_bank.png", "start": 7850647, "end": 7851770}, {"filename": "/game_data/template_meshes.dat", "start": 7851770, "end": 7852282}], "remote_package_size": 7852282});

  })();

// end include: C:\Users\jtoom\AppData\Local\Temp\tmp8jui6aki.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmpreaub1ge.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmpreaub1ge.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmpwbsu37u1.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmpwbsu37u1.js
...
var ASM_CONSTS = {
  156016: ($0) => { if (!window._keepaliveRegistered) { window._keepaliveRegistered = true; window._keepaliveInterval = null; window._keepaliveSocketHandle = $0; document.addEventListener('visibilitychange', function() { if (document.hidden) { window._keepaliveInterval = setInterval(function() { try { var handle = window._keepaliveSocketHandle; if (typeof WS !== 'undefined' && WS.sockets && WS.sockets[handle]) { var ws = WS.sockets[handle]; if (ws.readyState === 1) { ws.send(new Uint8Array([9])); } } } catch (e) {} }, 2000); } else { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } } }); } },  
 156659: () => { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } },  
 156774: () => { if (document.fullscreenElement) return 1; },  
 156820: () => { return Module.canvas.width; },  
 156852: () => { return parseInt(Module.canvas.style.width); },  
 156900: () => { document.exitFullscreen(); },  
 156927: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 157000: () => { if (document.fullscreenElement) return 1; },  
 157046: () => { return Module.canvas.width; },  
 157078: () => { return screen.width; },  
 157103: () => { document.exitFullscreen(); },  
 157130: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 157263: () => { return window.innerWidth; },  
 157289: () => { return window.innerHeight; },  
 157316: () => { if (document.fullscreenElement) return 1; },  
 157362: () => { return Module.canvas.width; },  
 157394: () => { return parseInt(Module.canvas.style.width); },  
 157442: () => { if (document.fullscreenElement) return 1; },  
 157488: () => { return Module.canvas.width; },  
 157520: () => { return screen.width; },  
 157545: () => { return window.innerWidth; },  
 157571: () => { return window.innerHeight; },  
 157598: () => { if (document.fullscreenElement) return 1; },  
 157644: () => { return Module.canvas.width; },  
 157676: () => { return screen.width; },  
 157701: () => { document.exitFullscreen(); },  
 157728: () => { if (document.fullscreenElement) return 1; },  
 157774: () => { return Module.canvas.width; },  
 157806: () => { return parseInt(Module.canvas.style.width); },  
 157854: () => { document.exitFullscreen(); },  
 157881: ($0) => { Module.canvas.style.opacity = $0; },  
 157919: () => { return screen.width; },  
 157944: () => { return screen.height; },  
 157970: () => { return window.screenX; },  
 157997: () => { return window.screenY; },  
 158024: () => { return window.devicePixelRatio; },  
 158060: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 158113: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 158164: () => { Module.canvas.style.cursor = 'none'; },  
 158201: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 158457: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 158508: () => { if (document.fullscreenElement) return 1; },  
 158554: () => { return window.innerWidth; },  
 158580: () => { return window.innerHeight; },  
 158607: () => { if (document.pointerLockElement) return 1; },  
 158654: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 160812: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 160976: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 161080: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 161251: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 164079: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 164145: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 164538: ($0) => { miniaudio.untrack_device_by_index($0); },  
 164581: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 164706: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
