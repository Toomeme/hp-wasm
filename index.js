...
// include: C:\Users\jtoom\AppData\Local\Temp\tmpcfulmucr.js
...
// end include: C:\Users\jtoom\AppData\Local\Temp\tmpcfulmucr.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmpe2bx4086.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmpe2bx4086.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmp3w1uz82v.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmp3w1uz82v.js
...
var ASM_CONSTS = {
  155984: ($0) => { if (!window._keepaliveRegistered) { window._keepaliveRegistered = true; window._keepaliveInterval = null; window._keepaliveSocketHandle = $0; document.addEventListener('visibilitychange', function() { if (document.hidden) { window._keepaliveInterval = setInterval(function() { try { var handle = window._keepaliveSocketHandle; if (typeof WS !== 'undefined' && WS.sockets && WS.sockets[handle]) { var ws = WS.sockets[handle]; if (ws.readyState === 1) { ws.send(new Uint8Array([9])); } } } catch (e) {} }, 2000); } else { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } } }); } },  
 156627: () => { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } },  
 156742: () => { if (document.fullscreenElement) return 1; },  
 156788: () => { return Module.canvas.width; },  
 156820: () => { return parseInt(Module.canvas.style.width); },  
 156868: () => { document.exitFullscreen(); },  
 156895: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 156968: () => { if (document.fullscreenElement) return 1; },  
 157014: () => { return Module.canvas.width; },  
 157046: () => { return screen.width; },  
 157071: () => { document.exitFullscreen(); },  
 157098: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 157231: () => { return window.innerWidth; },  
 157257: () => { return window.innerHeight; },  
 157284: () => { if (document.fullscreenElement) return 1; },  
 157330: () => { return Module.canvas.width; },  
 157362: () => { return parseInt(Module.canvas.style.width); },  
 157410: () => { if (document.fullscreenElement) return 1; },  
 157456: () => { return Module.canvas.width; },  
 157488: () => { return screen.width; },  
 157513: () => { return window.innerWidth; },  
 157539: () => { return window.innerHeight; },  
 157566: () => { if (document.fullscreenElement) return 1; },  
 157612: () => { return Module.canvas.width; },  
 157644: () => { return screen.width; },  
 157669: () => { document.exitFullscreen(); },  
 157696: () => { if (document.fullscreenElement) return 1; },  
 157742: () => { return Module.canvas.width; },  
 157774: () => { return parseInt(Module.canvas.style.width); },  
 157822: () => { document.exitFullscreen(); },  
 157849: ($0) => { Module.canvas.style.opacity = $0; },  
 157887: () => { return screen.width; },  
 157912: () => { return screen.height; },  
 157938: () => { return window.screenX; },  
 157965: () => { return window.screenY; },  
 157992: () => { return window.devicePixelRatio; },  
 158028: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 158081: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 158132: () => { Module.canvas.style.cursor = 'none'; },  
 158169: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 158425: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 158476: () => { if (document.fullscreenElement) return 1; },  
 158522: () => { return window.innerWidth; },  
 158548: () => { return window.innerHeight; },  
 158575: () => { if (document.pointerLockElement) return 1; },  
 158622: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 160780: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 160944: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 161048: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 164047: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 164113: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 164506: ($0) => { miniaudio.untrack_device_by_index($0); },  
 164549: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 164674: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
