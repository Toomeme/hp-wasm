...
// include: C:\Users\jtoom\AppData\Local\Temp\tmp_zjtmq53.js
...
Module['FS_createPath']("/", "game_data", true, true);
    ...
    loadPackage({"files": [{"filename": "/game_data/ASSETS.PAK", "start": 0, "end": 813092}, {"filename": "/game_data/ASSETS.TOC", "start": 813092, "end": 822752}, {"filename": "/game_data/AUDIO.PAK", "start": 822752, "end": 961440}, {"filename": "/game_data/AUDIO.TOC", "start": 961440, "end": 962556}, {"filename": "/game_data/BIG.PAK", "start": 962556, "end": 1008320}, {"filename": "/game_data/BIG.TOC", "start": 1008320, "end": 1009036}, {"filename": "/game_data/BIR.PAK", "start": 1009036, "end": 1035944}, {"filename": "/game_data/BIR.TOC", "start": 1035944, "end": 1037068}, {"filename": "/game_data/CHARDB.BIN", "start": 1037068, "end": 1037232}, {"filename": "/game_data/FNT.PAK", "start": 1037232, "end": 1048232}, {"filename": "/game_data/FNT.TOC", "start": 1048232, "end": 1048404}, {"filename": "/game_data/LOGO.PAK", "start": 1048404, "end": 1053784}, {"filename": "/game_data/LOGO.TOC", "start": 1053784, "end": 1053888}, {"filename": "/game_data/MOO.PAK", "start": 1053888, "end": 1123488}, {"filename": "/game_data/MOO.TOC", "start": 1123488, "end": 1125020}, {"filename": "/game_data/PALMETA.BIN", "start": 1125020, "end": 1125064}, {"filename": "/game_data/ST1.ogg", "start": 1125064, "end": 7071760}, {"filename": "/game_data/WIN.ogg", "start": 7071760, "end": 7463130}, {"filename": "/game_data/map.bin", "start": 7463130, "end": 7849831}, {"filename": "/game_data/menu.bin", "start": 7849831, "end": 7965157}, {"filename": "/game_data/palette_bank.png", "start": 7965157, "end": 7966751}, {"filename": "/game_data/template_meshes.dat", "start": 7966751, "end": 7967263}], "remote_package_size": 7967263});

  })();

// end include: C:\Users\jtoom\AppData\Local\Temp\tmp_zjtmq53.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmp432590bz.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmp432590bz.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmpukowh9b9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmpukowh9b9.js
...
var ASM_CONSTS = {
  153152: ($0) => { if (!window._keepaliveRegistered) { window._keepaliveRegistered = true; window._keepaliveInterval = null; window._keepaliveSocketHandle = $0; document.addEventListener('visibilitychange', function() { if (document.hidden) { window._keepaliveInterval = setInterval(function() { try { var handle = window._keepaliveSocketHandle; if (typeof WS !== 'undefined' && WS.sockets && WS.sockets[handle]) { var ws = WS.sockets[handle]; if (ws.readyState === 1) { ws.send(new Uint8Array([9])); } } } catch (e) {} }, 2000); } else { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } } }); } },  
 153795: () => { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } },  
 153910: () => { if (document.fullscreenElement) return 1; },  
 153956: () => { return Module.canvas.width; },  
 153988: () => { return parseInt(Module.canvas.style.width); },  
 154036: () => { document.exitFullscreen(); },  
 154063: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 154136: () => { if (document.fullscreenElement) return 1; },  
 154182: () => { return Module.canvas.width; },  
 154214: () => { return screen.width; },  
 154239: () => { document.exitFullscreen(); },  
 154266: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 154399: () => { return window.innerWidth; },  
 154425: () => { return window.innerHeight; },  
 154452: () => { if (document.fullscreenElement) return 1; },  
 154498: () => { return Module.canvas.width; },  
 154530: () => { return parseInt(Module.canvas.style.width); },  
 154578: () => { if (document.fullscreenElement) return 1; },  
 154624: () => { return Module.canvas.width; },  
 154656: () => { return screen.width; },  
 154681: () => { return window.innerWidth; },  
 154707: () => { return window.innerHeight; },  
 154734: () => { if (document.fullscreenElement) return 1; },  
 154780: () => { return Module.canvas.width; },  
 154812: () => { return screen.width; },  
 154837: () => { document.exitFullscreen(); },  
 154864: () => { if (document.fullscreenElement) return 1; },  
 154910: () => { return Module.canvas.width; },  
 154942: () => { return parseInt(Module.canvas.style.width); },  
 154990: () => { document.exitFullscreen(); },  
 155017: ($0) => { Module.canvas.style.opacity = $0; },  
 155055: () => { return screen.width; },  
 155080: () => { return screen.height; },  
 155106: () => { return window.screenX; },  
 155133: () => { return window.screenY; },  
 155160: () => { return window.devicePixelRatio; },  
 155196: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 155249: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 155300: () => { Module.canvas.style.cursor = 'none'; },  
 155337: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 155593: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 155644: () => { if (document.fullscreenElement) return 1; },  
 155690: () => { return window.innerWidth; },  
 155716: () => { return window.innerHeight; },  
 155743: () => { if (document.pointerLockElement) return 1; },  
 155790: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 157948: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 158112: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 158216: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 158387: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 161215: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 161281: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 161674: ($0) => { miniaudio.untrack_device_by_index($0); },  
 161717: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 161842: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
