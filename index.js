...
// include: C:\Users\jtoom\AppData\Local\Temp\tmpmanww9kj.js
...
// end include: C:\Users\jtoom\AppData\Local\Temp\tmpmanww9kj.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmpb1t8ssaw.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmpb1t8ssaw.js
// include: C:\Users\jtoom\AppData\Local\Temp\tmpmv2s6c5_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\jtoom\AppData\Local\Temp\tmpmv2s6c5_.js
...
var ASM_CONSTS = {
  156928: ($0) => { if (!window._keepaliveRegistered) { window._keepaliveRegistered = true; window._keepaliveInterval = null; window._keepaliveSocketHandle = $0; document.addEventListener('visibilitychange', function() { if (document.hidden) { window._keepaliveInterval = setInterval(function() { try { var handle = window._keepaliveSocketHandle; if (typeof WS !== 'undefined' && WS.sockets && WS.sockets[handle]) { var ws = WS.sockets[handle]; if (ws.readyState === 1) { ws.send(new Uint8Array([9])); } } } catch (e) {} }, 2000); } else { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } } }); } },  
 157573: () => { if (window._keepaliveInterval) { clearInterval(window._keepaliveInterval); window._keepaliveInterval = null; } },  
 157688: () => { if (document.fullscreenElement) return 1; },  
 157734: () => { return Module.canvas.width; },  
 157766: () => { return parseInt(Module.canvas.style.width); },  
 157814: () => { document.exitFullscreen(); },  
 157841: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 157914: () => { if (document.fullscreenElement) return 1; },  
 157960: () => { return Module.canvas.width; },  
 157992: () => { return screen.width; },  
 158017: () => { document.exitFullscreen(); },  
 158044: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 158177: () => { return window.innerWidth; },  
 158203: () => { return window.innerHeight; },  
 158230: () => { if (document.fullscreenElement) return 1; },  
 158276: () => { return Module.canvas.width; },  
 158308: () => { return parseInt(Module.canvas.style.width); },  
 158356: () => { if (document.fullscreenElement) return 1; },  
 158402: () => { return Module.canvas.width; },  
 158434: () => { return screen.width; },  
 158459: () => { return window.innerWidth; },  
 158485: () => { return window.innerHeight; },  
 158512: () => { if (document.fullscreenElement) return 1; },  
 158558: () => { return Module.canvas.width; },  
 158590: () => { return screen.width; },  
 158615: () => { document.exitFullscreen(); },  
 158642: () => { if (document.fullscreenElement) return 1; },  
 158688: () => { return Module.canvas.width; },  
 158720: () => { return parseInt(Module.canvas.style.width); },  
 158768: () => { document.exitFullscreen(); },  
 158795: ($0) => { Module.canvas.style.opacity = $0; },  
 158833: () => { return screen.width; },  
 158858: () => { return screen.height; },  
 158884: () => { return window.screenX; },  
 158911: () => { return window.screenY; },  
 158938: () => { return window.devicePixelRatio; },  
 158974: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 159027: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 159078: () => { Module.canvas.style.cursor = 'none'; },  
 159115: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 159371: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 159422: () => { if (document.fullscreenElement) return 1; },  
 159468: () => { return window.innerWidth; },  
 159494: () => { return window.innerHeight; },  
 159521: () => { if (document.pointerLockElement) return 1; },  
